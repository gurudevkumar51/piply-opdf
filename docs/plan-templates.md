...
**Status: Phase Q and Phase B are built. Everything else is plan.**
...
| **Layout knowledge** | "What kind of region is this?" | ❌ nothing |
...
```
piply-opdf layout-kb stats | export <file> | import <file> | match <page>
piply-opdf template  list  | show <name>  | export <file> | import <file>
```
